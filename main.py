...
SPECIALTY_CHANNELS = [
    {
        ...
        "specialties": [ "eclusion dentist", "surgery", "general surgery", "trauma", "orthopaedic", "plastic", "vascular", "urology", "neurosurgery", "pediatric surgery"],
    ...
    },
    {
        ...
        "specialties": ["medicine", "acute", "internal", "general medicine", "cardiology", "respiratory", "gastroenterology", "neurology", "haematology", "rheumatology"],
        "grades":      ["fy1", "fy2", "foundation", "st4", "st5", "st6", "st7", "ct1", "ct2", "ct3", "st1", "st2", "st3", "registrar", "trust", "doctor", "grade", "clinical", "fellow", "specialty", "junior", "locum", "teaching", "senior"],
